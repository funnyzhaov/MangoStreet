package me.funnyzhao.mangostreet.ui.customview;
...
public class XfeImageView  extends ImageView{
    ...
    public XfeImageView(Context context) {
        this(context,null);
        mPaint = new Paint();
        mPaint.setAntiAlias(true);
    }

    public XfeImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mPaint = new Paint();
        mPaint.setAntiAlias(true);
    ...
    public XfeImageView(Context context, AttributeSet attrs, int defStyleAttr) {
