 ...
 * 我的发布物品  RecyclerView Adapter
 * 通过ItemTouchHelper来实现物品的侧滑删除功能.
 */

public class IssueGoodsAdapter extends
        RecyclerView.Adapter<IssueGoodsAdapter.ViewHolder>
    ...
    public IssueGoodsAdapter(List<Item> data, Context context){
        mItemList = data;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //加载布局文件
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.issue_goods_item,parent,false);
